...
if (!function_exists('wcc_time_hours_dropdown')) {

    function wcc_time_hours_dropdown($attr = array()) {
...
if (!function_exists('wcc_time_minutes_dropdown')) {

  function wcc_time_minutes_dropdown($attr = array()) {
...
if ( ! function_exists( 'wcc_selected_timezone' ) ) {

    /**
     * Return selected WordPress time zone by admin
     */
    function wcc_selected_timezone() {
