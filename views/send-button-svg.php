<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="70.094" height="68.381" viewBox="0 0 70.094 68.381">
    <defs>
        <style>
            .wcc-cls-1, .wcc-cls-2 { fill: <?php echo esc_html( $this->appearance_settings['bg_color'] ) ?>; }
            .wcc-cls-2 { opacity: 0.5; }
            .wcc-cls-3 { filter: url(#Path_9); }
            .wcc-cls-4 { filter: url(#Path_8); }
        </style>
